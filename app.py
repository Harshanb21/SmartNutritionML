...
class AdvancedFitnessML:
    ...
    def _init_all_models(self):
        ...
        # MODEL 6: Time-Series (initialized on-demand)
        print("  ✓ Model 6: Time-Series Analysis")
        
        # MODEL 7: NLP (initialized on-demand)
    ...
    def model_1_knn_similar_users(self, user_profile, k=3):
        ...
        user_features = np.array([[
            user_profile['age'], user_profile['activity_level'],
    ...
    def model_2_cluster_segmentation(self, user_profile):
        ...
        cluster_descriptions = {
            0: "Active & Fit", 1: "Sedentary & Overweight",
            2: "Moderate Activity", 3: "Young & Active", 4: "Health Conscious"
        }
    ...
    def model_3_predict_outcomes(self, user_profile):
        ...
        return {
            ...
            'data': {
                ...
                'projection': 'High' if weight_loss_potential > 7 else 'Medium' if weight_loss_potential > 5 else 'Low'
            }
        }
    ...
    def model_5_collaborative_recommend(self, n=3):
        ...
        # Recommend most nutritious foods
    ...
    def model_7_nlp_food_search(self, query):
        ...
        results = []
        for name, sim, cal, protein in top_matches:
            results.append({
                'name': name,
...
def get_all_models_recommendation():
    """Get recommendations from ALL 7 ML models"""
    try:
...
def get_individual_model(model_name):
    """Get recommendation from specific ML model"""
    try:
        user_data = request.json
        user_profile = {
            'age': user_data['age'],
